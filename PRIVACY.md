...
Forge is maintained by thunderock. It is an open-source fork of [Parallel Code](https://github.com/johannesjo/parallel-code) by Johannes Millan (MIT). Questions or concerns can be raised as an issue on the [GitHub repository](https://github.com/thunderock/forge/issues) or by email at [findashutoshtiwari@gmail.com](mailto:findashutoshtiwari@gmail.com). GitHub issues are public — please do not include personal data, secrets (API keys, tokens), or anything you would not want indexed by search engines. If a question requires sharing personal data, use email rather than posting it publicly.
